...
exports.ProjectServiceClient = exports.ProjectServiceService = exports.UserServiceClient = exports.UserServiceService = exports.TeamResponse = exports.UserRequest = exports.ProjectResponse = exports.ProjectRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
function createBaseProjectResponse() {
    return {
        id: 0,
        name: "",
        projectDescription: "",
...
exports.ProjectResponse = {
    ...
    create(base) {
        return exports.ProjectResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
exports.ProjectServiceService = {
    getProjectDetails: {
        ...
        responseSerialize: (value) => Buffer.from(exports.ProjectResponse.encode(value).finish()),
        responseDeserialize: (value) => exports.ProjectResponse.decode(value),
    },
};
